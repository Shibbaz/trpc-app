...
exports.appRouter = (0, trpc_1.router)({
    helloUser: trpc_1.publicProcedure.input(zod_1.z.object({
        ...
        var input = _a.input;
        return {
            text: "Hello ".concat(input.text)
        };
    }),
    usersList: trpc_1.publicProcedure.query(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    onUpadateUser: trpc_1.publicProcedure.subscription(function () {
